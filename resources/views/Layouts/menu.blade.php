...
{{--            FACEBOOK--}}
            <li class="mx-2 flex items-center justify-center">
                <a href="https://www.facebook.com/falconmilanjanos" target="_blank" class="transition ease-in delay-50 hover:-translate-y-0.5 hover:scale-110 duration-100">
...
{{--            INSTAGRAM--}}
            <li class="mx-2 flex items-center justify-center whitespace-nowrap">
                <a href="https://www.instagram.com/falcon.video/?fbclid=IwAR30LWr717sS6JOAarFnOpNBYInG4FTQl2DV8ZbEhBZ4cAVIB2fRLNI3evQ" target="_blank" class="transition ease-in delay-50 hover:-translate-y-0.5 hover:scale-110 duration-100">
...
{{--            YOUTUBE--}}
            <li class="mx-2 flex items-center justify-center">
                <a href="https://www.youtube.com/channel/UCXom5i0sow5m7UvRb6HHvGg" target="_blank" class="transition ease-in delay-50 hover:-translate-y-0.5 hover:scale-110 duration-100">
