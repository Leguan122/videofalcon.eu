    ...
    <div class="min-h-[calc(100vh-24px)]">
        <div class="flex flex-col py-20">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 justify-items-center mb-20">
                <div class="flex flex-col items-center m-8 py-2 rounded w-56 h-52">
                    <div class="border-slate-50 border rounded-full p-4 mb-6">
                    ...
                    <div>
                        <p class="text-white text-center"> +421 948 460 199</p>
                    </div>
                </div>
                <div class="flex flex-col items-center mx-8 md:m-8 py-2 rounded w-56 h-52">
                    <div class="border-slate-50 border rounded-full p-4 mb-6">
