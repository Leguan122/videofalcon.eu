...
{{--<div class="min-w-full min-h-screen bg-stone-900 grid place-items-center">--}}
...
{{--            </div>--}}
{{--            <div class="p-8">--}}
{{--                <div class="uppercase tracking-wide text-sm text-white font-semibold">Kontaktujte ma:</div>--}}
{{--                <form>--}}
{{--                    <label for="Title" class="text-white">Nadpis:</label><br>--}}
{{--                    <input type="text" name="Title"><br>--}}
{{--                    <label for="core" class="text-white">Text:</label><br>--}}
{{--                    <textarea name="core"></textarea><br>--}}
...
{{--</div>--}}
    <div>
        <div class="flex flex-col py-20">
            ...
            <div class="w-1/2 bg-stone-800 rounded-lg place-self-center p-8">
